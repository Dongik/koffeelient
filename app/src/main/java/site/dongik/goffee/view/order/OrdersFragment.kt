 ...
 * [OrdersFragment.OnListFragmentInteractionListener] interface.
 */
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?,
        ...
        if (view is RecyclerView) {
            with(view) {
                ...
                adapter = OrderAdapter(OrderContent.ITEMS, listener)
...
//                adapter = OrderAdapter()
    ...
    interface OnListFragmentInteractionListener {
        ...
        fun onListFragmentInteraction(item: OrderContent.OrderItem?)
    }
